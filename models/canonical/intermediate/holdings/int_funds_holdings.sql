...
{{ replay_quantity(ref('int_funds_transactions'),
                   qty_col='transaction_quota_quantity',
                   date_col='transaction_conversion_date') }},
...
holding AS (
    SELECT
        ...
        bool_or(abs(quota_quantity - replay.replay_quantity) >= 0.001)  AS has_stale_lot,
